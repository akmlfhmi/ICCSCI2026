...
This repository does not contain real user credentials, passwords, private keys, production secrets, or confidential data.
...
All uploaded files are provided for academic review and project evidence purposes only.

Sensitive information has been removed before uploading.
